...
`;
  ...
  function workOnImages(img1, img2, dImg) {
    loader.crossOrigin = '';
    var texture1 = loader.load(img1, render);
    var texture2 = loader.load(img2, render);
    var disp = loader.load(dImg, render);
  ...
  workOnImages(image1, image2, dispImage);
  this.next = transitionIn;
  this.previous = transitionOut;
  this.specificClick = function(currImage, newImage, displacement) {
    console.log(currImage, newImage);
    workOnImages(currImage, newImage, displacement);
    TweenMax.to(mat.uniforms.dispFactor, speedIn, {
      value: 1,
      ease: easing,
      onUpdate: render,
